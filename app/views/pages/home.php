      ...
      <h2 class="text-2xl font-bold">Popular books</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <?php foreach ($books as $book): ?>
            <article
                    class="bg-gray-800 rounded-lg overflow-hidden shadow-lg relative mb-2"
                  >
                    <span
      ...
      <h2 class="text-2xl font-bold mt-8">Popular authors</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php foreach ($authors as $author): ?>
          <article class="bg-gray-800 rounded-lg overflow-hidden shadow-lg mb-2">
                  <img
                    class="w-full h-48 object-cover"
                    src="<?php echo $author['picture']; ?>"
                    alt="<?php echo $author['fristname']; ?> <?php echo $author['lastname']; ?>"
                  />
                  <div class="p-4">
